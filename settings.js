...
//======= Change settings =======\\
global.owner = process.env.OWNER_NUMBER || "923706302550"
global.botname = process.env.BOT_NAME || "αhsan"
global.ownername = process.env.OWNER_NAME || "Ahsan King"; //set bot owner name here 
global.prefix = process.env.PREFIX || "."; // your desired prefix symbol only
global.timezone = process.env.TIME_ZONE || "Africa/Lagos";
global.author = process.env.AUTHOR  || "ITX-ahsan";
global.packname = process.env.PACK_NAME  || "ITX-ahsan ²⁵";
